                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/supplier/edit.php" method="POST" class="edit-save-form">
                                                    <div class="form-body">
                                                      
                                                      <div class="alert alert-danger display-hide">
                                                        <button class="close" data-close="alert"></button>
                                                            <span>Enter proper supplier details</span>
                                                        </div>
                                                       ...
                                                       <div class="form-group clearfix">
                                                        ...
                                                        <div class="form-group clearfix">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="email" id="supplier_email" name="supplier_email" class="form-control" placeholder="Supplier Email" /> </div>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit "id="edit_save" type="button" class="btn btn-primary" name="edit_supplier">Save changes</button>
                                                        </div>
<!---->
                                                    </div>
                                                </form>
...
<![endif]-->
    ...
    <script src="../assets/pages/scripts/edit-supplier.js"></script>
    ...
    if(isset($_SESSION['status']) &&
        ...
        ?>
    <script>
        toastr["success"]("You Successfully edited!", "Supplier Edit")
...
<?php
    if(isset($_SESSION['status']) &&
        ...
        ?>
    <script>
        toastr["success"]("You Successfully deleted!", "Supplier Delete")
