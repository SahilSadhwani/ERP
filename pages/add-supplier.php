            ...
            if(isset($_GET['q']))
            {
                if($_GET['q'] == 'success'){
                    echo"<div class='alert alert-success'>
                        <button class='close' data-close='alert'></button> You have successfully inserted a new supplier!</div>";
                }else if($_GET['q'] == 'error'){
                    if($_GET['status'] == 'supplier'){
                        echo "<div class='alert alert-danger'>
                            <button class='close' data-close='alert'></button>Contact already exists in supplier!</div>";
                    }
    ...
    ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="supplier_email" type="email" class="form-control" placeholder="Supplier Email" /> </div>
                                                <div class="col-md-4"><label></label></div>
                                        </div>
                                        
                                        
                                         <div class="form-group">
                                            <label class="control-label col-md-3">Supplier GST No. </label>
                                            <div class="col-md-4">
...
<![endif]-->
    ...
    <script src="../assets/pages/scripts/add-supplier.js"></script>
